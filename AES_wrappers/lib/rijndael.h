...
char* encd( char *password, char *file_name);
char* decd( char *password, char *file_name);
//char* enc_dec( char *password, char *file_name);
//int k( char *password, char *file_name);
